...
const UPCOMING = [{
  ...
  venue: 'BRET',
  region: 'Local',
  title: "King's Day at BRET",
  headliners: ['Tommy Chikara', 'Reiss', 'Morgan'],
  support: ['Luna Ludmila', 'Grant Dell', 'Giammarco Orsini', 'David Triana'],
  doors: '18:00',
  close: '08:00',
  status: 'ON SALE',
  ticketUrl: 'https://nl.ra.co/events/2387190',
  buyUrl: 'https://shop.weeztix.com/4830a0bf-a5df-4aef-8f5d-cfa3161a5091/tickets?shop_code=7mag5qtq&event=d4b4f5a2-c372-47fd-8463-f17f889e9b85',
  provider: 'RA',
  blurb: "On this day, the city moves different. King's Day at BRET returns — day-to-night on the terrace.",
  image: {
    src: _img('flyerKingsday', 'site/assets/flyers/kingsday.jpg'),
    label: "King's Day — BRET, Amsterdam"
  }
}, {
  id: 'evt-sunnyside-malta',
  slug: 'sunny-side-festival-malta-2026',
  date: '2026-05-17',
  dateLabel: '17.05.26',
  day: 'SUN',
  city: 'Malta',
  ...
  title: 'Sunny Side Festival',
  headliners: ['Raresh b2b Cap', 'MATO', 'Alexia Glensy'],
  support: [],
  doors: '20:00',
  close: '03:00',
  status: 'ON SALE',
  ticketUrl: 'https://nl.ra.co/events/2314648',
  buyUrl: 'https://shotgun.live/en/festivals/sunny-side-festival-malta-26',
  provider: 'Sunny Side',
  blurb: 'VBX sunset-to-sunrise on the island. z-a billing, one room, long sets.',
  image: {
    src: _img('flyerSunnySide', 'site/assets/flyers/sunny-side.jpg'),
    label: 'Sunny Side — Malta'
  }
}, {
  id: 'evt-planet-paradigm-26',
  slug: 'planet-paradigm-2026',
  date: '2026-05-30',
  dateLabel: '30.05.26',
  day: 'SAT',
  city: 'Groningen',
  venue: 'PARADIGM',
  region: 'Local',
  title: 'Planet Paradigm 2026',
  headliners: ['Rhadoo', 'Kim Ann Foxman', 'GiGi FM b2b Altinbas', 'Mareena', 'Pancratio b2b Simone de Kunovich'],
  support: ['A For Alpha', 'Aldonna b2b Matisa', 'Alexia Glensy b2b Alex Dima', 'Christian Thomas b2b aotp', 'Eli Verveine', 'Emmz', 'Gabriel Belabbas', 'Hamish & Toby', 'ISAbella', 'Reflex Blue (live)', 'Reiss', 'Richard Akingbehin b2b Matthew Neequaye', 'Rosati (live)', 'S-Candalo', 'Talismann'],
  doors: '13:00',
  close: '23:00',
  status: 'ON SALE',
  ticketUrl: 'https://paradigm050.com/events/planet-paradigm-2026/',
  buyUrl: 'https://shop.weeztix.com/fdc49b3f-d749-4146-8b19-d71a92267c85/tickets?shop_code=gsv9fsd6&original_referer=https%3A%2F%2Fparadigm050.com%2F&event=2b92c88e-99da-4fe2-ae12-eead2d7c9085',
  provider: 'Paradigm',
  blurb: 'In 2026, cosmic paths will cross again. Paradigm × VBX in the woods outside Groningen — one day, all stages.',
  image: {
    src: _img('flyerParadigm', 'site/assets/flyers/planet-paradigm.jpeg'),
    label: 'Planet Paradigm — Paradigm, Groningen'
  }
}, {
  id: 'evt-unum-albania',
  slug: 'unum-festival-2026',
  date: '2026-06-04',
  dateLabel: '04.06.26',
  day: 'THU',
  city: 'Shengjin',
  venue: 'UNUM',
  region: 'International',
  title: "Unum Festival '26",
  headliners: ['Voigtmann b2b Alci', 'Reiss', 'Dyed Soundorom'],
  support: ['Doudou MD', 'Altin Boshnjaku', 'Alexia Glensy'],
  doors: '19:00',
  close: '11:00',
  status: 'ON SALE',
  ticketUrl: '#',
  buyUrl: 'https://unumfestival.com/tickets/#/event/unum-festival-the-dreamscape/201397',
  provider: 'Unum',
  blurb: 'VBX returns to the Albanian coast. 16 hours, z-a billing, sunrise guaranteed.',
  image: {
    src: _img('flyerUnum', 'site/assets/flyers/unum.jpeg'),
    label: "Unum Festival '26 — Shengjin, Albania"
  }
}, {
  id: 'evt-polifonic-offweek',
  slug: 'polifonic-vbx-outcast-offweek-2026',
  date: '2026-06-18',
  dateLabel: '18.06.26',
  day: 'THU',
  city: 'Barcelona',
  venue: 'ZT HOTEL · WOLF CLUB',
  region: 'International',
  title: 'Polifonic × VBX × Outcast — Off Week Barcelona',
  headliners: ['Jane Fitz', 'John Talabot', 'Nicolas Lutz', 'Unai Trotti'],
  support: ['Brasi', 'Alexia Glensy b2b Alex Dima', 'Michelle (live)', 'Lumiere'],
  doors: '14:00',
  close: '06:00',
  status: 'ON SALE',
  ticketUrl: 'https://ra.co/events/2385552',
  provider: 'RA',
  blurb: 'Day: ZT Hotel 14:00–22:00. Night: Wolf Club 22:00–06:00. Powered by Loud-Contact for Off Week Barcelona.',
  image: {
    src: _img('flyerPolifonic', 'site/assets/flyers/polifonic.jpeg'),
    label: 'Polifonic × VBX × Outcast — Barcelona'
  }
}, {
  id: 'evt-solid-am-bcn',
  slug: 'vbx-x-solid-am-2026',
  date: '2026-06-20',
  dateLabel: '20.06.26',
  day: 'SAT',
  city: 'Barcelona',
  venue: 'THE UPLOAD CLUB',
  region: 'International',
  title: 'VBX × Solid AM',
  headliners: ['Frank Haag', 'Eli Verveine b2b', 'Alexander Skancke'],
  support: ['dj sweet6teen', 'Boy Miguel'],
  doors: '23:00',
  close: '06:00',
  status: 'ON SALE',
  ticketUrl: 'https://nl.ra.co/events/2412357',
  provider: 'Loud-Contact',
  blurb: 'Poble Espanyol, closing Off Week. VBX × Solid AM — long-form all night.',
  image: {
    src: _img('flyerSolidAm', 'site/assets/flyers/solid-am.jpg'),
    label: 'VBX × Solid AM — The Upload Club, Barcelona'
  }
}, {
  ...
  image: {
    src: _img('flyerPloegendienst', 'site/assets/flyers/ploegendienst.jpg'),
    label: 'VBX × Ploegendienst — Galderse Meren, Breda'
  }
}, {
  ...
  buyUrl: 'https://weeztix.shop/ryfxa463',
  provider: 'RA',
  blurb: 'Summer weekend residency at Tillatec. Full line-up announced shortly.',
  image: {
    src: _img('flyerTillatec', 'site/assets/flyers/tillatec.jpg'),
    label: 'VBX Summer Weekend — Tillatec, Amsterdam'
  },
...
// FEBRUARY 2026
{
  ...
  venue: 'LE 211',
  city: 'Paris',
  title: 'Automatic X VBX Afterparty',
  soldOut: true,
...
// JANUARY 2026
{
  ...
  venue: 'WHY NOT CLUB',
  city: 'Zanzibar, TZ',
  title: 'VBX x Sunny Side Festival x Why?Not',
  lineup: ['UJ/DV', 'Reiss', 'Morgan', 'Hamish & Toby', 'JNJS', 'Bella Sarris']
}, {
  date: '2026-01-10',
  dateLabel: '10.01.26',
  day: 'SAT',
  venue: 'LOST BEACH CLUB',
  city: 'Ecuador',
  title: 'VBX — Trotamundo',
...
// DECEMBER 2025
{
  ...
  venue: 'TILLATEC',
  city: 'Amsterdam',
  title: 'VBX 24hrs | TILLATEC 06.12',
  soldOut: true,
  pick: true,
...
// OCTOBER 2025 — ADE week
{
  ...
  venue: 'TILLATEC',
  city: 'Amsterdam',
  title: 'VBX, fabric & Loud-Contact present: PLAYGROUND',
  soldOut: true,
  ...
  venue: 'TBA',
  city: 'Amsterdam',
  title: 'VBX x SlapFunk x ReSolute pres: Can You Jigit?',
  soldOut: true,
  ...
  venue: 'LOFI',
  city: 'Amsterdam',
  title: 'Ben UFO curates VBX [sold out]',
  soldOut: true,
...
// JUNE 2025
{
  ...
  city: 'Barcelona',
  title: 'VBX OFF BCN 2025 at Les Enfants',
...
// MAY 2025
{
  ...
  venue: 'PARADIGM',
  city: 'Netherlands',
  title: 'Planet Paradigm 2025: A One Day Festival Trip',
  soldOut: true,
...
// APRIL 2025
{
  ...
  venue: 'BRET',
  city: 'Amsterdam',
  title: "VBX King's Day — The Day After",
  pick: true,
...
// MARCH 2025
{
  ...
  venue: 'MULTIPLA',
  city: 'Amsterdam',
  title: 'VBX12 Weekender Part 1 — Multipla',
  pick: true,
...
// NOVEMBER 2024
{
  ...
  venue: 'LOFI',
  city: 'Amsterdam',
  title: 'VBX x SlapFunk present: fabric 25 Continuum',
...
// OCTOBER 2024 — ADE
{
  ...
  venue: 'RASA86',
  city: 'Amsterdam',
  title: 'VBX x SlapFunk ADE — Rasa86',
  soldOut: true,
...
// SEPTEMBER 2024
{
  ...
  venue: 'LOFI',
  city: 'Amsterdam',
  title: 'VBX & Paradigm present: PLANET Lofi',
  soldOut: true,
...
// JUNE 2024
{
  ...
  venue: 'LES ENFANTS BRILLANTS',
  city: 'Barcelona',
  title: 'SlapFunk x VBX Night time',
  ...
  venue: 'BOSC TANCAT',
  city: 'Barcelona',
  title: 'SlapFunk x VBX — Closing OFF BCN 2024 Day Time',
  ...
  venue: 'BRET',
  city: 'Amsterdam',
  title: 'VBX | SUMMER 1 — BRET — ALL DAY',
  lineup: []
}, {
  date: '2024-06-08',
  dateLabel: '08.06.24',
  ...
  venue: 'LOFI',
  city: 'Amsterdam',
  title: 'VBX | SUMMER 1 — Lofi — Day & Night',
...
// MARCH 2024
{
  ...
  venue: 'BROOKLYN',
  city: 'New York City',
  title: 'SlapFunk x VBX x Golden Record NYC',
...
// DECEMBER 2023
{
  ...
  venue: 'NUMBER 90',
  city: 'London',
  title: 'VBX 10 YEARS TOUR — LONDON',
  pick: true,
...
// OCTOBER 2023 — ADE
{
  ...
  venue: 'IJLAND',
  city: 'Amsterdam',
  title: 'VBX x SlapFunk ADE — Ijland',
  soldOut: true,
  ...
  venue: 'LEVENSLANG',
  city: 'Amsterdam',
  title: 'VBX x SUNRISE ADE — LEVENSLANG',
  soldOut: true,
  ...
  city: 'Lisbon',
  title: 'VBX x Mīrarī x Ministerium Club',
...
// SEPTEMBER 2023
{
  ...
  city: 'Madrid',
  title: 'Roots pres. VBX 10 Years Tour',
...
// JULY 2023
{
  ...
  venue: 'BRET',
  city: 'Amsterdam',
  title: 'VBX Summer Weekender — BRET',
  lineup: ['CHKLTE']
}, {
  date: '2023-07-29',
  dateLabel: '29.07.23',
  ...
  venue: 'LOFI',
  city: 'Amsterdam',
  title: 'VBX Summer Weekender — Lofi',
  ...
  venue: 'RSO',
  city: 'Berlin',
  title: '10 Years VBX x Planet Pleasure',
...
// JUNE 2023
{
  ...
  dateLabel: '18.06.23',
  day: 'SUN',
  venue: 'HOLA CLUB SITGES',
  city: 'Barcelona',
  title: 'VBX x SlapFunk On The Beach | OFFBCN 23',
  pick: true,
  ...
  venue: 'BRET',
  city: 'Amsterdam',
  title: 'VBX x Sunrise Afterhours',
...
// JUNE 2022
{
  ...
  venue: 'PROGRESS',
  city: 'Manchester',
  title: 'You&Me x VBX — Jubilee Bank Holiday',
...
// APRIL 2021
{
  ...
  venue: 'LOFI',
  city: 'Amsterdam',
  title: 'VBX & SlapFunk present: People in Love',
  pick: true,
...
// JANUARY 2020
{
  ...
  venue: 'LOFI',
  city: 'Amsterdam',
  title: 'SlapFunk & VBX present: New Years Day',
...
// DECEMBER 2019
{
  ...
  venue: 'VERONICASCHIP',
  city: 'Amsterdam',
  title: 'VBX Afterhours — Veronicaschip',
...
// OCTOBER 2019 — ADE
{
  ...
  venue: 'VERONICASCHIP',
  city: 'Amsterdam',
  title: 'VBX — ADE Afterhours Veronicaschip',
  soldOut: true,
  ...
  city: 'Amsterdam',
  title: 'Ricardo Villalobos X FRRC X VBX',
  soldOut: true,
...
// AUGUST 2019
{
  ...
  venue: 'BRET',
  city: 'Amsterdam',
  title: 'VBX — A day at the Terrace',
  pick: true,
  ...
  venue: 'BRET',
  city: 'Amsterdam',
  title: 'VBX — Bret — A Long Summer Night & Day',
...
// JUNE 2019
{
  ...
  dateLabel: '16.06.19',
  day: 'SUN',
  venue: 'SINT-PAULUSINSTITUUT',
  city: 'Brussels',
  title: 'LifeSnacks Open Air 02',
  ...
  city: 'London',
  title: 'Junction 2 Festival 2019',
  pick: true,
...
// FEBRUARY 2019
{
  ...
  venue: 'WAREHOUSE ELEMENTENSTRAAT',
  city: 'Amsterdam',
  title: 'VBX with RPR Soundsystem',
  pick: true,
...
// JANUARY 2019
{
  ...
  venue: 'SHELTER',
  city: 'Amsterdam',
  title: 'VBX with Ricardo Villalobos',
...
// OCTOBER 2018 — ADE
{
  ...
  venue: 'BRET',
  city: 'Amsterdam',
  title: 'VBX x tINI and the gang ADE',
  soldOut: true,
...
// AUGUST 2018
{
  ...
  venue: 'BRET',
  city: 'Amsterdam',
  title: 'VBX Summerseries with Barac',
...
// JUNE 2018
{
  ...
  venue: 'BRET',
  city: 'Amsterdam',
  title: 'VBX Summerseries with Sammy Dee',
...
// MARCH 2017
{
  ...
  venue: 'SHELTER',
  city: 'Amsterdam',
  title: 'VBX with tINI + Ferro + Makcim',
...
// FEBRUARY 2016
{
  ...
  venue: 'WAREHOUSE ELEMENTENSTRAAT',
  city: 'Amsterdam',
  title: 'Hyte x Fuse Carry-On (12hr)',
...
// AUGUST 2015
{
  ...
  venue: 'CRUQUIUSGILDE',
  city: 'Amsterdam',
  title: 'VBX 3yrs Anniversary Part 2',
  soldOut: true,
  ...
  venue: 'CLOSURE',
  city: 'Amsterdam',
  title: 'VBX 3yrs Anniversary Part 1',
  soldOut: true,
...
// JULY 2015
{
  ...
  venue: 'CRUQUIUSGILDE',
  city: 'Amsterdam',
  title: 'VBX x Summer Series Matinee Part 2',
...
// JUNE 2015
{
  ...
  venue: 'CRUQUIUSGILDE',
  city: 'Amsterdam',
  title: 'VBX x Summer Series Matinee 15hrs',
...
// OCTOBER 2014 — ADE
{
  ...
  venue: 'TOLHUISTUIN',
  city: 'Amsterdam',
  title: "ADE ' soldOut: true,14: VBX x Slapfunk x Natives",
  ...
  venue: 'SUGAR FACTORY',
  city: 'Amsterdam',
  title: "ADE ' soldOut: true,14: VBX x Surefire Agency",
...
// MARCH 2014
{
  ...
  city: 'Amsterdam',
  title: 'VBX — Spectrum with Linkwood',
  ...
  venue: 'DOKA',
  city: 'Amsterdam',
  title: 'VBX — Current with Terje Bakke',
...
// FEBRUARY 2014
{
  ...
  venue: 'STUDIO 80',
  city: 'Amsterdam',
  title: 'VBX — Workit with Dance Mania',
...
// JANUARY 2014
{
  ...
  venue: 'CHICAGO SOCIAL CLUB',
  city: 'Amsterdam',
  title: 'Spectrum feat. Alden Tyrell',
...
// DECEMBER 2013
{
  ...
  venue: 'CHICAGO SOCIAL CLUB',
  city: 'Amsterdam',
  title: 'Spectrum Feat. Funkineven',
...
// OCTOBER 2013
{
  ...
  venue: 'STUDIO/K',
  city: 'Amsterdam',
  title: 'Cartel & VBX ADE Night Festival',
  soldOut: true,
  lineup: ['Tyree Cooper', 'Mark E', 'Point G', 'Hold Youth', 'Molly', 'De Sluwe Vos', 'Samuel Deep', 'Makcim', 'Ferro', 'Steven Pieters']
}];
const VENUES = ['BRET', 'SHELTER', 'LOFI', 'TILLATEC', 'ISO', 'FABRIC', 'UPLOAD', 'PARADIGM', 'SUNNY SIDE', 'UNUM', 'ZT HOTEL · WOLF CLUB', 'THE UPLOAD CLUB', 'GALDERSE MEREN'];
const SOCIAL = {
  instagram: {
    handle: '@vbx.nu',
