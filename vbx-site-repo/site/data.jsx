...
const UPCOMING = [
  ...
  },
  {
    ...
    venue: 'BRET',
    region: 'Local',
    title: 'VBX Summer Closing — After',
    headliners: ['Secret Line-up'],
    support: [],
    doors: '08:30',
    close: '20:00',
    status: 'ON SALE',
    buyUrl: 'https://weeztix.shop/qeefffvq',
    provider: 'Weeztix',
    blurb: 'The morning after. Summer Closing spills into BRET, 08.30 to 20.00. Line-up stays secret.',
    image: { src: 'site/assets/flyers/summer-closing-after-2026.jpg', label: 'VBX Summer Closing After — BRET, Amsterdam' },
  },
  {
    ...
    headliners: ['Shanti Celeste', 'Pancratio', 'Doudou MD b2b Jennifer Loveless', 'A For Alpha'],
    support: ['More TBA'],
    doors: '20:00',
    close: '04:00',
    status: 'ON SALE',
    ...
    image: { src: 'site/assets/flyers/shanti-celeste-ade-2026.jpg', label: 'Shanti Celeste Curates VBX — Skatecafe, Amsterdam' },
  },
  {
    id: 'evt-vbx-lofi-ade',
    ...
    region: 'Local',
    title: 'VBX — Lofi',
    headliners: ['Paquita Gordon', 'Marco Shuttle', 'Frank Haag (live)', 'Francesco Del Garda', 'E.Lina', 'Dresden (Ivan Smagghe & Manfredas)', 'Christian AB'],
    support: [],
    doors: '23:59',
    close: '08:00',
    status: 'ON SALE',
    ...
    image: { src: 'site/assets/flyers/lofi-ade-2026.jpg', label: 'VBX — Lofi, Amsterdam' },
  },
  {
  ...
  },
  {
    ...
    region: 'Local',
    title: 'Can You Jigit? — VBX x Jigit x ReSolute',
    headliners: ['Line-up TBA'],
    support: [],
    status: 'ON SALE',
    ticketUrl: 'https://ra.co/events/2469610',
    provider: 'RA',
    blurb: 'ADE Saturday night. VBX x Jigit x ReSolute bring Can You Jigit? to a secret warehouse.',
    image: { src: 'site/assets/flyers/canyoujigit-2026.jpg', label: 'Can You Jigit? — Secret Warehouse, Amsterdam' },
  },
  {
    ...
    headliners: ['Oriana', 'Michelle (live)', 'Jane Fitz b2b Richard Fearless', 'Bitzer Maloney', 'Alexia Glensy'],
    support: [],
    doors: '13:00',
    close: '23:00',
    status: 'ON SALE',
    ...
    image: { src: 'site/assets/flyers/jane-fitz-ade-2026.jpg', label: 'Jane Fitz Curates VBX — Amsterdam' },
  },
  {
    ...
    headliners: ['Yamour', 'Reiss', 'Jorg Kuning (live)', 'Apollonia'],
    support: ['More TBA'],
    doors: '23:00',
    close: '08:00',
    status: 'ON SALE',
    ...
    image: { src: 'site/assets/flyers/apollonia-ade-2026.jpg', label: 'Apollonia Curates VBX — Shelter, Amsterdam' },
  },
  {
    id: 'evt-tillatec-fabric-loudcontact-ade',
    slug: 'vbx-fabric-loud-contact-tillatec-ade-2026',
    date: '2026-10-26',
    dateLabel: '26.10.26',
    day: 'MON',
    city: 'Amsterdam',
    venue: 'TILLATEC',
    region: 'Local',
    title: 'VBX x fabric x Loud-Contact',
    headliners: ['Binh', 'Francesco Del Garda', 'Gabrielle Kwarteng', 'H-Foundation', 'Konduku', 'Magda', 'Morgan', 'Roza Terenzi'],
    support: ['More TBA'],
    doors: '09:00',
    close: '00:00',
    status: 'ON SALE',
    ...
    provider: 'RA',
    blurb: 'ADE Monday, presented by TILLATEC. VBX x fabric x Loud-Contact from morning to midnight.',
    image: { src: 'site/assets/flyers/tillatec-fabric-loudcontact-2026.jpg', label: 'VBX x fabric x Loud-Contact — Tillatec, Amsterdam' },
  },
];

const ARCHIVE = [
  // AUGUST 2026
  { date: '2026-08-01', dateLabel: '01.08.26', day: 'SAT', venue: 'BRET', city: 'Amsterdam', title: 'VBX Pride',
    blurb: 'VBX celebrates Pride at BRET. Z\u2013a all night, 20:00 to 08:00.',
    lineup: ['Poggio', 'Hannecart', 'Gabriel Belabbas', 'Franziska Berns', 'DIEDE', 'Charlotte'],
  ...
  // JULY 2026
  { date: '2026-07-05', dateLabel: '05.07.26', day: 'SUN', venue: 'DE FIK GARDEN', city: 'Amsterdam', title: 'VBX Summer Weekend — After at De Fik',
    blurb: 'The Sunday after. A garden session at De Fik to close the summer weekend.',
    lineup: [],
  ...
  { date: '2026-07-04', dateLabel: '04.07.26', day: 'SAT', venue: 'TILLATEC', city: 'Amsterdam', title: 'VBX Summer Weekend — Tillatec',
    blurb: 'Summer weekend residency at Tillatec, 23:00 to 08:00.',
    lineup: ['ZTO', 'Rey Colino', 'Paquita Gordon', 'Muallem', 'Michelle (live)', 'Ion Ludwig', 'Ekkel', 'Alexia Glensy'],
    image: { src: 'site/assets/flyers/tillatec-summer-2026.jpg', label: 'VBX Summer Weekend — Tillatec, Amsterdam' } },
  { date: '2026-07-04', dateLabel: '04.07.26', day: 'SAT', venue: 'GALDERSE MEREN', city: 'Breda', title: 'VBX × Ploegendienst',
    blurb: 'Outdoor afternoon-to-evening at Galderse Meren. VBX teams with Ploegendienst.',
    lineup: ['Quest', 'Ogaz\u00f3n', 'Francesco Del Garda', 'Bjolf b2b Boy Miguel', 'Alexia Glensy'],
    image: { src: 'site/assets/flyers/ploegendienst.png', label: 'VBX × Ploegendienst — Galderse Meren, Breda' } },
