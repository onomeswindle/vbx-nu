...
const UPCOMING = [
  ...
  },
  {
    ...
    headliners: ['Rey Colino', 'Paquita Gordon', 'Muallem', 'Ion Ludwig', 'Ekkel', 'Alexia Glensy'],
    support: [],
    doors: '23:00',
    close: '08:00',
    status: 'ON SALE',
    ...
    image: { src: _img('flyerTillatec', 'site/assets/flyers/tillatec.png'), label: 'VBX Summer Weekend — Tillatec, Amsterdam' },
  ...
  },
  {
    ...
    buyUrl: 'https://weeztix.shop/qczarsds',
    provider: 'Weeztix',
  ...
  {
    id: 'evt-can-you-jigit-ade',
    slug: 'can-you-jigit-vbx-ade-2026',
    date: '2026-10-24',
    dateLabel: '24.10.26',
    day: 'SAT',
    city: 'Amsterdam',
    ...
    support: [],
    status: 'ON SALE',
    buyUrl: 'https://weeztix.shop/z95rrqeb',
    provider: 'Weeztix',
    blurb: 'VBX x SlapFunk x ReSolute present Can You Jigit? — ADE at ISO.',
    image: { src: null, label: 'Can You Jigit? — ISO, Amsterdam' },
  },
  {
