...
const UPCOMING = [
  ...
  },
  {
    ...
    region: 'Local',
    title: 'VBX Pride',
    headliners: ['Poggio', 'Hannecart', 'Gabriel Belabbas', 'Franziska Berns', 'DIEDE', 'Charlotte'],
    support: [],
    doors: '20:00',
    close: '08:00',
    status: 'ON SALE',
  ...
  },
  {
    ...
    region: 'Local',
    title: 'VBX — Lofi',
    headliners: ['Paquita Gordon', 'Marco Shuttle', 'Frank Haag (live)', 'Francesco Del Garda', 'E.Lina', 'Dresden', 'Christian AB'],
    support: [],
    doors: '23:59',
    close: '08:00',
    status: 'ON SALE',
